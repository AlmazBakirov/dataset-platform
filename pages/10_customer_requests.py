...
with st.expander("Create new request", expanded=True):
    ...
    if st.button("Create", type="primary"):
        try:
            ...
            if req_id:
                st.session_state["selected_request_id"] = req_id  # запоминаем выбранную заявку
...
try:
    ...
    if not items:
        ...
        if not labels:
            ...
            # выбираем по умолчанию то, что было создано/выбрано ранее
